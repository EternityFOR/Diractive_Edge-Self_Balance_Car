...
static void example_event_callback(esp_blufi_cb_event_t event, esp_blufi_cb_param_t *param)
{
    ...
    case ESP_BLUFI_EVENT_BLE_CONNECT:
        ...
        esp_blufi_adv_stop();
        blufi_security_init();
        if(xTimerStop(switch_back_to_original_ble_timer, 0) != pdPASS) {
            BLUFI_INFO("Timeout timer stops failed\n");
        }
        break;
